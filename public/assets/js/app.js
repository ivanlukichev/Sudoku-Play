(function () {
  ...
  function getCurrentPathname() {
    try {
      return new window.URL(window.location.href).pathname || "/";
    } catch (error) {
      return "/";
    }
  }
  ...
  function buildCleanAbsoluteUrl(pathname, params, hash) {
    ...
    return origin + buildCleanRelativeUrl(pathname, params, hash);
  }
  ...
  function updateLocationState(difficulty, puzzleId, preferHomeForEasy, includePuzzleParam) {
    ...
    try {
      ...
      window.history.replaceState({}, "", buildCleanRelativeUrl(getRouteForDifficulty(difficulty, preferHomeForEasy), params, url.hash));
    } catch (error) {
      return;
    }
  }
  ...
  SudokuApp.prototype.syncPageLocation = function (includePuzzleParam) {
    ...
    try {
      ...
      window.history.replaceState({}, "", buildCleanRelativeUrl(this.getRoutePath(this.currentDifficulty), params, url.hash));
    } catch (error) {
      return;
    }
  };
